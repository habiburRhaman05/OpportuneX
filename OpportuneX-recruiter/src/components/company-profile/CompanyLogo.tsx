...
import { Camera, Check, Loader, Loader2, Upload, X } from "lucide-react";
...
const CompanyLogo = () => {
  ...
  const handleDeletePhoto = async () => {
    await deletePhotoMutation.mutateAsync({ logo: "" });
      ...
      <div className="relative">
        <Avatar className="h-28 w-28 border-2 border-zinc-600">
          {isUploading ? (
            ...
            <AvatarImage
              src={(logo as string) || "/placeholder.svg?height=80&width=80"}
            />
          )}
