...
import { AlertCircle, Briefcase, Building2, Plus, X } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      <div className="space-y-8">
        ...
        <div className="flex justify-end animate-fade-in-up animation-delay-700 mt-8">
          <Button
