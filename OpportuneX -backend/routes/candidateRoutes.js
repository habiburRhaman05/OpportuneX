...
router.post("/auth/verify-otp",authenticatedRoutes,authorize("candidate"), verifyOtp);

// Protected routes
router.put("/auth/profile/update",authenticatedRoutes,authorize("candidate"), updateCandidateProfile);
router.put("/auth/onboarding/email-verify", authenticatedRoutes ,authorize("candidate"),verifyOtp);
router.put("/auth/onboarding/profile-info",authenticatedRoutes, authorize("candidate"), updateProfileInfo);
// Protected profile route
router.get("/auth/profile/me",authenticatedRoutes,authorize("candidate"), getCandidateProfile);
